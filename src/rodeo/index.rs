...
impl IndexFile {
  ...
  pub fn read_index(&self) -> Result<Vec<ItemOffset<ItemLoc>>> {
  ...
  pub fn read_index_at_byte_offset(&self, pos: usize) -> Result<ItemOffset<ItemLoc>> {
...
impl ItemOffset<ItemLoc> {
  pub fn read<R: Read>(reader: &mut R) -> Result<ItemOffset<ItemLoc>> {
